...
import cv2
from rlnn import LunarLander_DQN
...
class LunarLander_Agent:
    def __init__(self, env):
        ...
        self.N = 65536#32768#16384    #There appears to be a problem with catastrophic forgetting
        self.mem = 1
        self.batch_size = 64 #may want to experiment with batch_size

        self.COUNTER_MAX = 16
        self.refresh_counter = self.COUNTER_MAX

        self.current_state = torch.zeros(2,1)
    ...
    def observe(self, observation, reward, done):
        ...
        #    del self.replay_memory[int(self.N/self.mem)]
        #self.replay(done)
