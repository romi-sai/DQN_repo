...
import cv2
from rlnn import MountainCar_DQN
...
class MountainCar_Agent:
    def __init__(self, env):
        ...
        self.N = 16384    #There appears to be a problem with catastrophic forgetting
    ...
    def observe(self, observation, reward, done):
        ...
        #commented out this for mountaincar since it barely gets points anyway
